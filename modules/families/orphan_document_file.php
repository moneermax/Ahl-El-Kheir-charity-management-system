...
$id = (int)($_GET['id'] ?? 0);
$doc = dbFetchOne("SELECT d.*, f.nanny_id, f.supervisor_id, f.legacy_mother_first_letter FROM orphan_documents d LEFT JOIN families f ON f.id = d.family_id WHERE d.id = ?", [$id]);
