...
<tr><td><?php echo e($r['family_code']); ?></td><td><strong><?php echo e($r['mother_name']); ?></strong></td><td dir="ltr"><?php echo e($r['mother_phone'] ?? '-'); ?></td><td><?php echo $childCount; ?></td><td><?php echo (int)$r['active_sponsorships']; ?></td><td><?php echo number_format((float)$r['monthly_commitment'], 0); ?></td><td><?php echo e($r['nanny_name'] ?? '—'); ?></td><td><span class="badge <?php echo $sc; ?>"><?php echo $sl; ?></span></td><td class="text-center" style="white-space:nowrap;"><a class="btn btn-sm btn-primary" title="عرض" href="<?php echo APP_URL; ?>modules/families/view.php?id=<?php echo (int)$r['id']; ?>"><i class="fas fa-eye"></i></a><?php if ($role !== 'general_manager'): ?><a class="btn btn-sm btn-warning" title="تعديل" href="<?php echo APP_URL; ?>modules/families/edit.php?id=<?php echo (int)$r['id']; ?>"><i class="fas fa-pen"></i></a><?php endif; ?></td></tr>
