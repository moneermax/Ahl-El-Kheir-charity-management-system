    ...
    try {
        ...
        try {
            dbExecute("INSERT INTO audit_log
                ...
                json_encode(['full_name' => $user['full_name'], 'supervisor_status' => $user['supervisor_status'], 'is_active' => (int)$user['is_active'], 'released_sponsors' => $released], JSON_UNESCAPED_UNICODE),
                json_encode(['supervisor_status' => 'archived', 'is_active' => 0, 'released_sponsors' => $released], JSON_UNESCAPED_UNICODE),
        ...
        flash('error', 'تعذر تنفيذ عملية مغادرة المشرف. يرجى مراجعة سجل النظام.');
    }
...
<div class="container-fluid px-3 pb-4"><div class="d-flex justify-content-start"><a href="modules/supervisors/index.php" class="btn btn-outline-secondary" onclick="return akGoBack(this.href);"><i class="fa-solid fa-arrow-right me-1"></i> العودة</a></div></div>
