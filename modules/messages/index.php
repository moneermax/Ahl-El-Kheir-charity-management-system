...
<style id="msg-gmail-workspace">
.messages-shell{--mail-bg:#f6f8fc;--mail-sidebar:#f2f6fc;--mail-blue:#1a73e8;--mail-blue-dark:#0b57d0;--mail-selected:#d3e3fd;--mail-hover:#e8f0fe;--mail-text:#202124;--mail-muted:#5f6368;--mail-line:#dadce0;--mail-soft:#f1f3f4;--mail-font:'Cairo',Arial,sans-serif;direction:rtl;margin:0 -12px;font-family:var(--mail-font);font-size:14px;color:var(--mail-text);background:var(--mail-bg)}
.messages-shell,.messages-shell *{box-sizing:border-box}.messages-shell a{color:inherit}.messages-shell button,.messages-shell input,.messages-shell select,.messages-shell textarea{font-family:inherit}
.msg-toolbar{height:72px;padding:12px 20px;display:flex;align-items:center;gap:24px;background:var(--mail-bg);border-bottom:1px solid var(--mail-line)}
.msg-title{display:flex;align-items:center;gap:12px;min-width:205px}.msg-title-icon{width:38px;height:38px;display:grid;place-items:center;border-radius:50%;background:#fff;color:var(--mail-blue);font-size:18px}.msg-title h2{margin:0;font-size:1.05rem;font-weight:500;letter-spacing:-.2px}.msg-title p{margin:2px 0 0;color:var(--mail-muted);font-size:.66rem}
.msg-toolbar .msg-search-wrap{position:relative;flex:1;max-width:720px;margin-inline:auto}.msg-toolbar .msg-search{width:100%;height:44px;padding:0 46px 0 18px;border:0;border-radius:22px;background:#eaf1fb;color:var(--mail-text);font-size:.72rem;outline:0;transition:background .15s,box-shadow .15s}.msg-toolbar .msg-search:focus{background:#fff;box-shadow:0 1px 3px rgba(60,64,67,.28),0 0 0 1px #c7d9f8}.msg-toolbar .msg-search-wrap i{position:absolute;right:17px;top:50%;transform:translateY(-50%);color:var(--mail-muted);font-size:.78rem}.msg-settings{display:flex;align-items:center;gap:7px;color:var(--mail-muted);font-size:.68rem;white-space:nowrap}.msg-settings select{width:86px;height:30px;padding:0 7px;border:1px solid var(--mail-line);border-radius:5px;background:#fff;color:var(--mail-text);font-size:.66rem}
.msg-layout{display:grid;grid-template-columns:220px minmax(320px,390px) minmax(0,1fr);height:calc(100vh - 190px);min-height:560px;background:#fff;border-bottom:1px solid var(--mail-line);overflow:hidden}.msg-sidebar{grid-column:1;padding:18px 8px 12px;background:var(--mail-sidebar);border-inline-start:1px solid var(--mail-line);overflow:auto}.msg-compose-btn{display:inline-flex;align-items:center;justify-content:center;gap:9px;height:46px;min-width:150px;margin:0 4px 18px;padding:0 20px;border:0;border-radius:15px;background:#c2e7ff;color:#001d35;box-shadow:0 1px 3px rgba(60,64,67,.25);font-size:.76rem;font-weight:700;cursor:pointer}.msg-compose-btn:hover{background:#b3dcf5}.msg-nav{display:flex;flex-direction:column;gap:2px}.msg-nav a,.msg-nav button{display:flex;align-items:center;gap:13px;width:100%;min-height:37px;padding:0 14px;border:0;border-radius:0 18px 18px 0;background:transparent;color:var(--mail-text);text-align:start;text-decoration:none;font-size:.72rem;font-weight:500;cursor:pointer}.msg-nav a:hover,.msg-nav button:hover{background:var(--mail-hover)}.msg-nav a.active{background:var(--mail-selected);color:#001d35;font-weight:700}.msg-nav i{width:18px;color:var(--mail-muted);text-align:center}.msg-nav a.active i{color:var(--mail-blue-dark)}.msg-count{min-width:22px;margin-inline-start:auto;color:var(--mail-text);font-size:.62rem;font-weight:700}.msg-section-label{margin:22px 13px 7px;color:var(--mail-muted);font-size:.61rem;font-weight:700}.msg-sidebar>.small{padding:0 13px!important;font-size:.64rem!important;line-height:1.8!important}
.msg-list-pane{grid-column:2;display:flex;min-width:0;flex-direction:column;background:#fff;border-inline-start:1px solid var(--mail-line);border-inline-end:1px solid var(--mail-line)}.msg-list-head{min-height:54px;padding:10px 15px;display:flex;align-items:center;justify-content:space-between;gap:12px;background:#fff;border-bottom:1px solid var(--mail-line)}.msg-list-head h3{margin:0;flex:1;color:var(--mail-text);font-size:.84rem;font-weight:500}.msg-list-head>.msg-search-wrap{display:none}.msg-filter{display:flex;align-items:center;gap:3px}.msg-filter a{padding:7px 7px;border-bottom:2px solid transparent;color:var(--mail-muted);font-size:.62rem;text-decoration:none}.msg-filter a.active{border-color:var(--mail-blue);color:var(--mail-blue);font-weight:700}.msg-list{min-height:0;flex:1;overflow:auto;background:#fff}.msg-row{position:relative;display:flex;align-items:flex-start;gap:11px;width:100%;min-height:73px;padding:11px 14px;border:0;border-bottom:1px solid var(--mail-soft);background:#fff;color:var(--mail-text);text-decoration:none;cursor:pointer;transition:background .12s}.msg-row:hover{background:#f2f6fc}.msg-row.unread{background:#f8fbff}.msg-row.active{background:var(--mail-selected)}.msg-row.unread:before{content:'';position:absolute;right:0;top:0;bottom:0;width:3px;background:var(--mail-blue)}.msg-avatar{width:34px;height:34px;flex:0 0 34px;display:grid;place-items:center;border-radius:50%;background:#e8eaed;color:#5f6368;font-size:.72rem;font-weight:600}.msg-row-main{min-width:0;flex:1}.msg-row-top,.msg-row-bottom{display:flex;align-items:center;justify-content:space-between;gap:8px}.msg-name,.msg-subject{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:var(--mail-text);font-size:.71rem;font-weight:500}.msg-row.unread .msg-name,.msg-row.unread .msg-subject{font-weight:700}.msg-time{color:var(--mail-muted);font-size:.57rem;white-space:nowrap}.msg-subject{margin-top:3px}.msg-preview{margin-top:3px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:var(--mail-muted);font-size:.61rem}.msg-new{color:var(--mail-blue-dark);font-size:.53rem;font-weight:700}.msg-urgent{color:#d93025;font-size:.63rem}.msg-empty{height:100%;display:grid;place-items:center;text-align:center;color:var(--mail-muted)}.msg-empty>div{display:grid;justify-items:center;gap:8px}.msg-empty-icon,.msg-read-empty-icon{width:58px;height:58px;display:grid;place-items:center;border-radius:50%;background:var(--mail-soft);color:#9aa0a6}.msg-empty strong,.msg-read-empty strong{font-size:.78rem;font-weight:500}.msg-empty span,.msg-read-empty span{color:#9aa0a6;font-size:.64rem}
.msg-reading-pane{grid-column:3;min-width:0;display:flex;flex-direction:column;background:#fff}.msg-reading-pane.empty{align-items:center;justify-content:center}.msg-reading-head{min-height:64px;padding:12px 22px;display:flex;align-items:center;justify-content:space-between;gap:12px;border-bottom:1px solid var(--mail-line)}.msg-conv-person{display:flex;align-items:center;gap:10px;min-width:0}.msg-conv-name{color:var(--mail-text);font-size:.79rem;font-weight:600}.msg-conv-meta{margin-top:2px;color:var(--mail-muted);font-size:.58rem}.msg-conv-actions{display:flex;gap:2px}.msg-icon-btn{width:34px;height:34px;display:grid;place-items:center;border:0;border-radius:50%;background:transparent;color:var(--mail-muted);text-decoration:none;cursor:pointer}.msg-icon-btn:hover{background:var(--mail-soft);color:var(--mail-text)}.msg-thread{min-height:0;flex:1;overflow:auto;padding:28px 42px 30px}.msg-root{margin:0 0 18px;padding:0 0 22px;border-bottom:1px solid var(--mail-line);background:#fff}.msg-subject-large{margin:0 0 8px;color:var(--mail-text);font-size:1.23rem;font-weight:400}.msg-root-meta,.msg-bubble-time{color:var(--mail-muted);font-size:.61rem}.msg-root hr{margin:18px 0;border:0;border-top:1px solid var(--mail-soft)}.msg-body{color:var(--mail-text);font-size:.8rem;line-height:1.95;white-space:pre-wrap}.msg-bubble{padding:16px 0;border-top:1px solid var(--mail-soft);background:#fff}.msg-bubble.mine{background:#fff}.msg-bubble-head{display:flex;justify-content:space-between;align-items:center;margin-bottom:7px}.msg-bubble-name{color:var(--mail-text);font-size:.69rem;font-weight:600}.msg-attachments{display:flex;flex-wrap:wrap;gap:7px;margin-top:16px}.msg-attachment-item{display:flex;align-items:center;gap:7px;max-width:260px;padding:7px 9px;border:1px solid var(--mail-line);border-radius:6px;background:#f8fafd;font-size:.63rem}.msg-attachment-item a{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:var(--mail-blue-dark);text-decoration:none}.msg-attachment-size{color:var(--mail-muted);white-space:nowrap}.msg-attachment-del{border:0;background:transparent;color:var(--mail-muted);cursor:pointer}.msg-reply{padding:12px 24px 16px;border-top:1px solid var(--mail-line);background:#fff}.msg-reply-box{overflow:hidden;border:1px solid var(--mail-line);border-radius:8px;background:#fff;box-shadow:0 1px 2px rgba(60,64,67,.12)}.msg-reply textarea{display:block;width:100%;min-height:76px;max-height:190px;padding:12px 14px;border:0;resize:vertical;color:var(--mail-text);font-size:.76rem;outline:0}.msg-reply-tools{display:flex;align-items:center;justify-content:space-between;padding:6px 8px;border-top:1px solid var(--mail-soft)}.msg-tools{display:flex;align-items:center;gap:2px}.msg-tool{width:30px;height:30px;border:0;border-radius:50%;background:transparent;color:var(--mail-muted);cursor:pointer}.msg-tool:hover{background:var(--mail-soft);color:var(--mail-text)}.msg-send,.compose-send{padding:8px 16px;border:0;border-radius:18px;background:var(--mail-blue);color:#fff;font-size:.68rem;font-weight:600;cursor:pointer}.msg-send:hover,.compose-send:hover{background:var(--mail-blue-dark)}.msg-no-reply{padding:13px 24px;border-top:1px solid var(--mail-line);color:var(--mail-muted);font-size:.64rem}.msg-status,.msg-attachment-chip{display:none;color:var(--mail-muted);font-size:.6rem}.msg-status.show{display:inline}.msg-attachment-chip:not(:empty){display:inline;color:var(--mail-blue-dark);font-size:.62rem}.msg-reply-error,.compose-error{display:none;margin:0 0 8px!important;padding:7px 10px!important;font-size:.65rem!important}.msg-reply-error.show,.compose-error.show{display:block}.msg-read-empty{display:grid;justify-items:center;gap:8px;text-align:center}
.compose-modal .modal-dialog{max-width:600px;margin:1.75rem 1.75rem 1.75rem auto}.compose-modal .modal-content{overflow:hidden;border:0;border-radius:8px;box-shadow:0 8px 35px rgba(60,64,67,.35)}.compose-modal .modal-header{min-height:46px;padding:9px 12px;background:#404040;color:#fff;border:0}.compose-modal .modal-header h5{color:#fff;font-size:.78rem}.compose-modal .modal-header small{color:#d6d6d6!important}.compose-modal .modal-body{padding:0;background:#fff}.compose-modal .form-label{color:var(--mail-muted);font-size:.64rem}.compose-recipient{padding:12px 14px;background:#fff}.compose-modal .form-control,.compose-modal .form-select{border:0;border-bottom:1px solid #e5e7e9;border-radius:0;background:#fff;font-size:.72rem}.compose-modal .form-control:focus,.compose-modal .form-select:focus{border-bottom-color:var(--mail-blue);box-shadow:none}.compose-modal textarea{min-height:190px;padding:12px 14px}.compose-modal .modal-body>.mb-3,.compose-modal .modal-body>.mb-2{margin-inline:14px}.compose-modal .modal-footer{padding:8px 12px;background:#fff;border-top:1px solid var(--mail-soft)}.compose-cancel{border:0;background:transparent;color:var(--mail-muted);font-size:.68rem}.msg-attach-btn{padding:7px 10px;border:1px solid var(--mail-line);border-radius:6px;background:#fff;color:var(--mail-muted);font-size:.65rem}.compose-urgent{margin-inline:14px;color:var(--mail-muted);font-size:.64rem}.compose-urgent i{color:#d93025}.msg-toast{position:fixed;right:24px;bottom:24px;z-index:5000;display:none;padding:10px 16px;border-radius:4px;background:#323232;color:#fff;font-size:.7rem;box-shadow:0 2px 8px rgba(0,0,0,.25)}.msg-toast.show{display:block}
@media(max-width:1200px){.msg-layout{grid-template-columns:200px minmax(300px,350px) minmax(0,1fr)}.msg-thread{padding-inline:28px}}
@media(max-width:950px){.msg-layout{grid-template-columns:190px minmax(300px,1fr);position:relative}.msg-reading-pane{position:absolute;inset:0;z-index:50}}
@media(max-width:767px){.messages-shell{margin:0}.msg-toolbar{height:auto;min-height:60px;padding:8px 12px;gap:10px;flex-wrap:wrap}.msg-title{min-width:0;flex:1}.msg-title p,.msg-settings{display:none}.msg-toolbar .msg-search-wrap{order:3;flex-basis:100%;max-width:none}.msg-layout{display:block;height:auto;min-height:0}.msg-sidebar{padding:8px;border-bottom:1px solid var(--mail-line);border-inline-start:0}.msg-compose-btn{margin:0 0 8px}.msg-nav{display:grid;grid-template-columns:repeat(3,1fr)}.msg-nav a,.msg-nav button{justify-content:center;flex-direction:column;gap:2px;border-radius:8px;padding:7px 3px;font-size:.58rem}.msg-section-label,.msg-sidebar>.small{display:none}.msg-list-pane{border:0}.msg-list-head{min-height:50px}.msg-reading-pane{position:fixed;inset:0;z-index:3000}.msg-thread{padding:20px 14px}.msg-reply{padding:8px}.compose-modal .modal-dialog{max-width:none;margin:0}.compose-modal .modal-content{min-height:100vh;border-radius:0}}
</style>
