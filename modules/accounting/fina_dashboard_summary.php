...
try {
    ...
    echo json_encode(['ok'=>true,'pending'=>['count'=>(int)$pending['cnt']], 'approved'=>['count'=>(int)$approved['cnt'],'amount'=>(float)$approved['amount']], 'returned'=>['count'=>(int)$returned['cnt']], 'currencies'=>$currencies, 'account'=>$account, 'recent'=>$recent], JSON_UNESCAPED_UNICODE|JSON_UNESCAPED_SLASHES);
} catch (Throwable $e) {
