...
$automatedReferenceTypes=['transaction','transaction_void','disbursement','disbursement_return','disbursement_void','item_return','voucher','voucher_void','payroll','manual_void'];
...
$viewId=(int)($_GET['view']??0); $returnQuery=trim((string)($_GET['return']??'')); $backUrl=APP_URL.'modules/accounting/journal.php'; if($returnQuery!==''){$backUrl.='?'.ltrim(rawurldecode($returnQuery),'?');}
if($viewId){
