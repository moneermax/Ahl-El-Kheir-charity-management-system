    ...
    <div class="col-md-3">
        <div class="card border-0 shadow-sm h-100" style="border-right: 4px solid #1b4d8f !important;">
            <div class="card-body text-center">
                <div class="display-6 fw-bold text-primary mb-2"><?php echo number_format($stats['total_accounts']); ?></div>
                <div class="text-muted small fw-bold">إجمالي الحسابات</div>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card border-0 shadow-sm h-100" style="border-right: 4px solid #198754 !important;">
            <div class="card-body text-center">
                <div class="display-6 fw-bold text-success mb-2"><?php echo number_format($stats['asset_accounts']); ?></div>
                <div class="text-muted small fw-bold">حسابات الأصول</div>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card border-0 shadow-sm h-100" style="border-right: 4px solid #fd7e14 !important;">
            <div class="card-body text-center">
                <div class="display-6 fw-bold text-warning mb-2"><?php echo number_format($stats['expense_accounts']); ?></div>
                <div class="text-muted small fw-bold">حسابات المصروفات</div>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card border-0 shadow-sm h-100" style="border-right: 4px solid #6f42c1 !important;">
            <div class="card-body text-center">
                <div class="display-6 fw-bold text-info mb-2"><?php echo number_format($stats['revenue_accounts']); ?></div>
                <div class="text-muted small fw-bold">حسابات الإيرادات</div>
            </div>
        </div>
    </div>
</div>
...
<div class="row g-4">
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <div class="d-grid gap-2">
                    <a href="<?php echo APP_URL; ?>modules/accounting/accounts.php" class="btn btn-outline-primary">
                        <i class="fas fa-list me-2"></i>شجرة الحسابات
                    </a>
                    <a href="<?php echo APP_URL; ?>modules/accounting/journal.php" class="btn btn-outline-primary">
                        <i class="fas fa-book me-2"></i>القيد اليومي
                    </a>
                    <a href="<?php echo APP_URL; ?>modules/transactions/index.php" class="btn btn-outline-primary">
                        <i class="fas fa-exchange-alt me-2"></i>المعاملات المالية
                    </a>
                    <a href="<?php echo APP_URL; ?>modules/reports/financial.php" class="btn btn-outline-primary">
                        <i class="fas fa-chart-bar me-2"></i>التقارير المحاسبية
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-6">
        <div class="card shadow-sm">
            <div class="card-header bg-white fw-bold" style="color: #1b4d8f;">
                <i class="fas fa-chart-line me-2"></i>ملخص النشاط
            </div>
            <div class="card-body">
                <ul class="list-group list-group-flush">
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        القيود المحاسبية (آخر 30 يوم)
                        <span class="badge bg-primary rounded-pill"><?php echo number_format($stats['recent_entries']); ?></span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        المعاملات هذا الشهر
                        <span class="badge bg-success rounded-pill"><?php echo number_format($stats['monthly_transactions']); ?></span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        صرفيات قيد الاعتماد
                        <span class="badge bg-warning text-dark rounded-pill"><?php echo number_format($stats['pending_disbursements']); ?></span>
                    </li>
                </ul>
            </div>
        </div>
