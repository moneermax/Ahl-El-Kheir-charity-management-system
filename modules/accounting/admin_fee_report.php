...
if(!Session::isLoggedIn()||!in_array($role,['admin','financial_manager','general_manager','vice_general_manager'],true)){header('Location: '.APP_URL.'index.php');exit();}
