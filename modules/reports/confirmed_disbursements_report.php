...
ak_report_require_access('confirmed_disbursements');

$pageTitle = t('navigation.confirmed_transfers_report');
$active = 'reports';
...
<div class="card mb-4 fade-in">
    <div class="card-header">
        <h5 class="mb-0"><i class="fas fa-filter me-2"></i><?php echo e(t('common.search')); ?></h5>
    </div>
    <div class="card-body">
        <form method="get" class="row g-3">
            <div class="col-md-3">
                <label class="form-label"><?php echo e(t('common.month')); ?> (<?php echo e(t('accounting.from')); ?>)</label>
                <input type="month" name="month_from" class="form-control" value="<?php echo e($monthFrom); ?>">
            </div>
            <div class="col-md-3">
                <label class="form-label"><?php echo e(t('common.month')); ?> (<?php echo e(t('accounting.to')); ?>)</label>
            ...
            <div class="col-md-3">
                <label class="form-label"><?php echo e(t('families.specialist')); ?></label>
            ...
            <div class="col-12">
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-search me-1"></i><?php echo e(t('common.view')); ?>
                </button>
                <button type="button" onclick="window.print()" class="btn btn-outline-secondary">
                    <i class="fas fa-print me-1"></i><?php echo e(t('common.documents')); ?>
                </button>
            </div>
        </form>
    </div>
    ...
    <div class="col-md-3">
        <div class="card border-success fade-in">
            <div class="card-body text-center">
                ...
                <p class="text-muted mb-0"><?php echo e(t('common.completed')); ?></p>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card border-warning fade-in">
            <div class="card-body text-center">
                ...
                <p class="text-muted mb-0"><?php echo e(t('common.pending')); ?></p>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card border-primary fade-in">
            <div class="card-body text-center">
                ...
                <p class="text-muted mb-0"><?php echo e(t('common.status')); ?></p>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card border-info fade-in">
            <div class="card-body text-center">
                ...
                <h3><?php echo number_format((float)$totalConfirmedAmount, 0); ?> <?php echo e(t('accounting.currency_sdg')); ?></h3>
                <p class="text-muted mb-0"><?php echo e(t('accounting.amount')); ?></p>
            </div>
        </div>
    </div>
</div>
...
<div class="card fade-in">
    <div class="card-header">
        <h5 class="mb-0"><i class="fas fa-list me-2"></i><?php echo e($pageTitle); ?></h5>
    </div>
    <div class="card-body">
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr class="<?php echo $isComplete ? 'table-success' : ''; ?>">
                            ...
                            <td><?php echo number_format((float)$d['total_amount'], 0); ?> <?php echo e(t('accounting.currency_sdg')); ?></td>
                            <td class="text-success"><?php echo number_format((float)$d['confirmed_amount'], 0); ?> <?php echo e(t('accounting.currency_sdg')); ?></td>
                            <td>
                                <div class="progress" style="height: 20px;">
                                    <div class="progress-bar <?php echo $isComplete ? 'bg-success' : 'bg-info'; ?>" style="width: <?php echo $progress; ?>%;">
                                        <?php echo $progress; ?>%
                                    </div>
                                </div>
                            ...
                            <td>
                                <?php if ($d['status'] === 'received'): ?>
                                    <span class="badge bg-success"><i class="fas fa-check"></i> <?php echo e(t('common.completed')); ?></span>
                                <?php else: ?>
                                    <span class="badge bg-primary"><i class="fas fa-paper-plane"></i> <?php echo e(t('common.pending')); ?></span>
                                <?php endif; ?>
                            </td>
                            <td><?php echo e($d['transferred_at'] ?? '—'); ?></td>
                            <td>
                                <a href="<?php echo APP_URL; ?>modules/accounting/disbursements.php?view=<?php echo (int)$d['disbursement_id']; ?>" class="btn btn-sm btn-outline-primary">
                                    <i class="fas fa-eye"></i> <?php echo e(t('common.view')); ?>
                                </a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    ...
                    <tfoot class="table-light">
                        <tr>
                            <th colspan="4" class="text-end"><?php echo e(t('common.all')); ?>:</th>
                            <th><?php echo number_format(array_sum(array_column($disbursements, 'total_amount')), 0); ?> <?php echo e(t('accounting.currency_sdg')); ?></th>
                            <th class="text-success"><?php echo number_format($totalConfirmedAmount, 0); ?> <?php echo e(t('accounting.currency_sdg')); ?></th>
                            <th colspan="4"></th>
                        </tr>
                    </tfoot>
                </table>
