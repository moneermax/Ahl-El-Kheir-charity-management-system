...
if ($report_type === 'returns_voids') {
    $returns_voids = dbFetchAll("SELECT
        'return' as type, di.id, di.return_reason as reason, di.amount,
        di.returned_at as date, f.mother_name as entity_name, md.month,
        ...
        UNION ALL
        SELECT
        'void' as type, t.id, t.void_reason as reason, t.amount, t.voided_at as date,
