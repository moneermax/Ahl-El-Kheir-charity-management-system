...
<div class="fade-in">
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm h-100" style="border-right: 4px solid #1b4d8f !important;">
                <div class="card-body text-center">
                    ...
                    <div class="text-muted small fw-bold"><?php echo e(t('common.active')); ?> <?php echo e(t('common.sponsors')); ?></div>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card border-0 shadow-sm h-100" style="border-right: 4px solid #198754 !important;">
                <div class="card-body text-center">
                    ...
                    <div class="text-muted small fw-bold"><?php echo e(t('common.active')); ?> <?php echo e(t('common.sponsorships')); ?></div>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card border-0 shadow-sm h-100" style="border-right: 4px solid #fd7e14 !important;">
                <div class="card-body text-center">
                    ...
                    <div class="text-muted small fw-bold"><?php echo e(t('common.families')); ?></div>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card border-0 shadow-sm h-100" style="border-right: 4px solid #6f42c1 !important;">
                <div class="card-body text-center">
                    <div class="display-6 fw-bold" style="color: #6f42c1; font-size: 1.8rem;"><?php echo number_format($stats['monthly_commitment'], 0); ?> <span class="fs-6"><?php echo e(t('accounting.currency_sdg')); ?></span></div>
                    <div class="text-muted small fw-bold"><?php echo e(t('families.monthly_commitment')); ?></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card shadow-sm">
        <div class="card-header bg-white fw-bold" style="color: #1b4d8f;">
            <i class="fas fa-folder-open me-2"></i><?php echo e(t('navigation.reports')); ?>
        </div>
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    <a href="<?php echo APP_URL; ?>modules/reports/financial.php?from=<?php echo e($from); ?>&to=<?php echo e($to); ?>" class="text-decoration-none">
                        <div class="p-3 border rounded hover-shadow text-center" style="transition: all 0.2s;">
                            ...
                            <h6 class="mb-0 fw-bold"><?php echo e(t('navigation.accounting')); ?></h6>
                            <small class="text-muted"><?php echo e(t('accounting.amount')); ?></small>
                        </div>
                    </a>
                </div>
                <?php endif; ?>
                ...
                <div class="col-md-4">
                    <a href="<?php echo APP_URL; ?>modules/reports/sponsorship.php?from=<?php echo e($from); ?>&to=<?php echo e($to); ?>" class="text-decoration-none">
                        <div class="p-3 border rounded hover-shadow text-center" style="transition: all 0.2s;">
                            ...
                            <h6 class="mb-0 fw-bold"><?php echo e(t('navigation.sponsor_reports')); ?></h6>
                            <small class="text-muted"><?php echo e(t('common.sponsors')); ?> / <?php echo e(t('common.sponsorships')); ?></small>
                        </div>
                    </a>
                </div>
                <?php endif; ?>
                ...
                <div class="col-md-4">
                    <a href="<?php echo APP_URL; ?>modules/reports/operational.php?from=<?php echo e($from); ?>&to=<?php echo e($to); ?>" class="text-decoration-none">
                        <div class="p-3 border rounded hover-shadow text-center" style="transition: all 0.2s;">
                            ...
                            <h6 class="mb-0 fw-bold"><?php echo e(t('navigation.reports')); ?></h6>
                            <small class="text-muted"><?php echo e(t('common.actions')); ?></small>
                        </div>
                    </a>
                </div>
                <?php endif; ?>
                ...
                <div class="col-md-4">
                    <a href="<?php echo APP_URL; ?>modules/reports/orphaned_families.php?from=<?php echo e($from); ?>&to=<?php echo e($to); ?>" class="text-decoration-none">
                        <div class="p-3 border rounded hover-shadow text-center" style="transition: all 0.2s;">
                            ...
                            <h6 class="mb-0 fw-bold"><?php echo e(t('common.families')); ?></h6>
                            <small class="text-muted"><?php echo e(t('families.count', ['count' => $stats['orphaned_families']])); ?></small>
                        </div>
                    </a>
                </div>
                <?php endif; ?>
                ...
                <div class="col-md-4">
                    <a href="<?php echo APP_URL; ?>modules/reports/hr.php?from=<?php echo e($from); ?>&to=<?php echo e($to); ?>" class="text-decoration-none">
                        <div class="p-3 border rounded hover-shadow text-center" style="transition: all 0.2s;">
                            ...
                            <h6 class="mb-0 fw-bold"><?php echo e(t('navigation.employees')); ?></h6>
                            <small class="text-muted"><?php echo e(t('common.users')); ?></small>
                        </div>
                    </a>
                </div>
                <?php endif; ?>
