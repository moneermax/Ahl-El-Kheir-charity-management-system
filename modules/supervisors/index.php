...
<div class="welcome-section fade-in"><h2><?php echo e(t('supervisors.title')); ?></h2><p><?php echo e(t('navigation.supervisors_description') === 'navigation.supervisors_description' ? t('supervisors.title') : t('navigation.supervisors_description')); ?></p><div class="quick-actions mt-3"><a href="<?php echo APP_URL; ?>modules/supervisors/create.php" class="btn btn-primary btn-sm"><i class="fas fa-user-plus me-1"></i> <?php echo e(t('supervisors.add')); ?></a><a href="<?php echo APP_URL; ?>modules/supervisors/assign-letters.php" class="btn btn-secondary btn-sm"><i class="fas fa-font me-1"></i> <?php echo e(t('supervisors.reassign')); ?></a><a href="<?php echo APP_URL; ?>modules/supervisors/reassign-letters.php" class="btn btn-warning btn-sm"><i class="fas fa-right-left me-1"></i> <?php echo e(t('supervisors.reassign')); ?></a><a href="<?php echo APP_URL; ?>modules/supervisors/index.php?show_archived=<?php echo $showArchived?'0':'1'; ?>" class="btn btn-outline-dark btn-sm"><i class="fas <?php echo $showArchived?'fa-user-check':'fa-box-archive'; ?> me-1"></i><?php echo e($showArchived ? t('common.close') : t('common.archived')); ?></a></div></div>
<?php include dirname(__DIR__, 2) . '/includes/alerts.php'; ?>
<div class="alert alert-info fade-in py-2 mb-3"><i class="fas fa-circle-info me-1"></i><strong><?php echo e(t('common.status')); ?>:</strong> <?php echo e(t('supervisors.title')); ?> — <?php echo e(t('common.paused')); ?> / <?php echo e(t('common.archived')); ?>.<?php if(!$showArchived): ?> <span class="text-muted"><?php echo e(t('common.archived')); ?></span><?php endif; ?></div>
<div class="card fade-in"><div class="card-header py-3 d-flex justify-content-between align-items-center"><span><i class="fas fa-user-tie me-2"></i><?php echo e($showArchived ? t('common.archived') : t('supervisors.title')); ?></span><span class="badge bg-primary"><?php echo count($supervisors); ?> <?php echo e(t('supervisors.title')); ?></span></div><div class="card-body p-2 p-md-3"><div class="table-responsive"><table class="table table-hover align-middle mb-0 supervisor-management-table"><thead><tr><th class="text-center" style="width:42px">#</th><th><?php echo e(t('common.users')); ?></th><th class="letters-cell"><?php echo e(t('common.documents')); ?></th><th class="text-center"><?php echo e(t('common.actions')); ?></th><th class="text-center"><?php echo e(t('common.status')); ?></th><th class="text-center supervisor-actions"><?php echo e(t('common.actions')); ?></th></tr></thead><tbody>
<?php if(empty($supervisors)): ?><tr><td colspan="6" class="text-center text-muted py-5"><i class="fas fa-users-slash fa-2x mb-2 d-block"></i><?php echo e($showArchived ? t('common.archived') : t('common.no_data')); ?></td></tr>
