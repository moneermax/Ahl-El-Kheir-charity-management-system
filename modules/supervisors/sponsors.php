...
$G_LABEL = [
    'male' => t('supervisors.male'),
    'female' => t('supervisors.female'),
    '' => t('supervisors.gender_unknown')
];

$id = (int)($_GET['supervisor'] ?? 0);
if ($role === 'supervisor') { $id = Session::getUserId(); }
...
", [$id]);
if (!$sup) {
    flash('error', t('supervisors.sponsor_not_found'));
...
<div class="row g-4 mb-4 fade-in">
    <div class="col-md-4">
        <div class="card text-center"><div class="card-body">
            ...
            <div class="text-muted small"><?php echo e(t('supervisors.total_sponsors')); ?></div>
        </div></div>
    </div>
    <div class="col-md-4">
        <div class="card text-center"><div class="card-body">
            <div class="fs-3 fw-bold" style="color:#1b4d8f"><?php echo $activeCount; ?></div>
            <div class="text-muted small"><?php echo e(t('supervisors.active_sponsors')); ?></div>
        </div></div>
    </div>
    <div class="col-md-4">
        <div class="card text-center"><div class="card-body">
            <div class="fs-3 fw-bold" style="color:#1b4d8f"><?php echo number_format((float)($commit['total'] ?? 0), 0); ?></div>
            <div class="text-muted small"><?php echo e(t('supervisors.monthly_commitment_active')); ?></div>
        </div></div>
    </div>
</div>
<div class="card fade-in">
    <div class="card-header"><i class="fas fa-hand-holding-heart me-2"></i><?php echo e(t('supervisors.sponsors_list', ['count' => $total])); ?></div>
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-hover align-middle">
                <thead>
                <tr>
                    <th><?php echo e(t('supervisors.code')); ?></th>
                    <th><?php echo e(t('supervisors.name')); ?></th>
                    <th><?php echo e(t('supervisors.letter')); ?></th>
                    <th><?php echo e(t('supervisors.gender')); ?></th>
                    <th><?php echo e(t('supervisors.phone')); ?></th>
                    <th><?php echo e(t('supervisors.type')); ?></th>
                    <th><?php echo e(t('supervisors.active_sponsorships')); ?></th>
                    <th><?php echo e(t('supervisors.status')); ?></th>
                    <th></th>
                </tr>
                </thead>
                <tbody>
                <?php if (!$sponsors): ?>
                    <tr><td colspan="9" class="text-center text-muted py-4"><?php echo e(t('supervisors.no_sponsors')); ?></td></tr>
                <?php else: foreach ($sponsors as $r): ?>
                    <tr>
                        <td><?php echo e($r['sponsor_code']); ?></td>
                        <td>
                            <strong><?php echo e($r['full_name']); ?></strong>
                            <?php if (!empty($r['ak_direct'])): ?><span class="badge bg-info" title="<?php echo e(t('supervisors.direct_title')); ?>"><?php echo e(t('supervisors.direct')); ?></span><?php endif; ?>
                        </td>
                        ...
                        <td>
                            <a class="btn btn-sm btn-primary" title="<?php echo e(t('supervisors.view')); ?>" href="<?php echo APP_URL; ?>modules/sponsors/view.php?id=<?php echo (int)$r['id']; ?>">
