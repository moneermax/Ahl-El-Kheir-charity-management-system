...
if (!in_array($role, ['admin','vice_general_manager','general_manager','supervisor','accountant','accountant_staff','financial_manager'], true)) { header('Location: ' . APP_URL . 'index.php'); exit(); }
