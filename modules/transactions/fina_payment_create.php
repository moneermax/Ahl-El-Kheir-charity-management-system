...
<div class="col-md-8" id="finaSponsorPicker"><label class="form-label">اختيار الكفيل *</label><div class="position-relative"><input type="text" id="finaSponsorSearch" class="form-control" autocomplete="off" placeholder="اكتب الاسم أو كود الكفيل أو الهاتف للبحث" value=""><input type="hidden" name="sponsor_id" id="finaSponsorId" value="<?php echo e($input['sponsor_id']); ?>"><div id="finaSponsorResults" class="list-group position-absolute w-100 shadow-sm" style="z-index:1050;max-height:280px;overflow-y:auto;display:none"></div></div><div id="finaSponsorSelected" class="form-text"></div></div>
