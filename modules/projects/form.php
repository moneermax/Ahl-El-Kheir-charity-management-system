        ...
        */
        ...
        if (!$id || $canEditRejectedBudget) {
            ...
            /*
             ...
             |--------------------------------------------------------------------------
             |
             | Initial budget lines MUST equal suggested budget + government fees.
             |--------------------------------------------------------------------------
             */
            ...
            if (
                ...
                $errors[] =
                    'تم إدخال ميزانية تقديرية ولكن لم تتم إضافة أي بنود ميزانية صحيحة. يجب أن تكون هناك بنود مجموعها يساوي الإجمالي المطلوب (الميزانية التقديرية + الرسوم الحكومية).';
            }
        }
            ...
            <div class="d-flex flex-column gap-3">
                ...
                <section class="project-form-section">
                    ...
                    <p class="text-muted small mb-3">
                        العملة ثابتة على الجنيه السوداني (SDG)، ويجب أن يساوي إجمالي بنود الميزانية الإجمالي المطلوب (الميزانية التقديرية + الرسوم الحكومية) تماماً.
                    </p>
...
function calculateTotalBudget() {
    ...
    if (!budgetIsActive) {
        ...
        if (message) {
            ...
            message.textContent =
                targetCents === 0
                    ? 'يجب أن تكون الميزانية التقديرية أكبر من صفر حتى يمكن التحقق من الإجمالي المطلوب وحفظ المشروع.'
                    : 'أدخل الميزانية التقديرية بقيمة أكبر من صفر حتى يمكن التحقق من الإجمالي المطلوب وحفظ المشروع.';
        }
    ...
    if (message) {
        ...
        message.textContent =
            '⚠ إجمالي بنود الميزانية أقل من الإجمالي المطلوب (الميزانية التقديرية + الرسوم الحكومية) بمبلغ ' +
            formatMoney(underAmount) +
            ' SDG. يجب أن يساوي الإجمالي المطلوب تماماً.';
    }
