<?php
// dashboard/accountant_dashboard.php - Accountant dashboard (v2 with Package 5 Outflows widget)
...
$recent = dbFetchAll("SELECT t.id, t.transaction_date, t.amount, t.receipt_number, s.full_name AS sponsor_name
