...
.hr-dashboard-actions{display:grid;grid-template-columns:repeat(6,minmax(0,1fr));gap:12px;margin-bottom:20px}.hr-action-card{position:relative;display:flex;align-items:center;min-width:0;min-height:72px;padding:11px 13px;gap:10px;border:1px solid #e5e9ee;border-radius:10px;background:#fff;color:#212529;text-decoration:none;box-shadow:0 2px 8px rgba(0,0,0,.045);transition:transform .18s ease,box-shadow .18s ease,border-color .18s ease}.hr-action-card:hover{color:#212529;transform:translateY(-2px);border-color:#cbd5e1;box-shadow:0 5px 14px rgba(0,0,0,.08)}.hr-action-icon{width:40px;height:40px;min-width:40px;border-radius:9px;display:inline-flex;align-items:center;justify-content:center;background:#f4f6f8;font-size:16px}.hr-action-content{min-width:0;display:flex;flex-direction:column;line-height:1.25}.hr-action-title{font-size:.86rem;font-weight:700;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.hr-action-subtitle{margin-top:3px;color:#6c757d;font-size:.69rem;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.hr-action-badge{position:absolute;top:7px;left:7px;min-width:21px}.qa-top-bar .qa-actions{display:none !important}
.hr-financial-tools{display:flex;align-items:center;justify-content:space-between;gap:16px;flex-wrap:wrap;background:#fff;border:1px solid #e5e9ee;border-right:4px solid #dc3545;border-radius:12px;padding:14px 16px;margin-bottom:20px;box-shadow:0 2px 8px rgba(0,0,0,.045)}.hr-financial-tools .tool-title{display:flex;align-items:center;gap:10px;font-weight:800;color:#344054}.hr-financial-tools .tool-title-icon{width:38px;height:38px;border-radius:9px;display:inline-flex;align-items:center;justify-content:center;background:#fff1f2;color:#dc3545}.hr-financial-tools .tool-subtitle{display:block;color:#6c757d;font-size:.72rem;font-weight:400;margin-top:2px}.hr-financial-tools .tool-link{white-space:nowrap}
@media (max-width:1399.98px){.hr-dashboard-actions{grid-template-columns:repeat(3,minmax(0,1fr))}}@media (max-width:767.98px){.hr-dashboard-actions{grid-template-columns:1fr 1fr}.grid-2{grid-template-columns:1fr}}@media (max-width:480px){.hr-dashboard-actions{grid-template-columns:1fr}.hr-action-card{min-height:68px}.hr-financial-tools .tool-link{width:100%}}
</style>
