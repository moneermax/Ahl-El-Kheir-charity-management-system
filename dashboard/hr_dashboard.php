...
@media (max-width:1399.98px){.hr-dashboard-actions{grid-template-columns:repeat(3,minmax(0,1fr))}}@media (max-width:767.98px){.hr-dashboard-actions{grid-template-columns:1fr 1fr}.grid-2{grid-template-columns:1fr}}@media (max-width:480px){.hr-dashboard-actions{grid-template-columns:1fr}.hr-action-card{min-height:68px}}
</style>
