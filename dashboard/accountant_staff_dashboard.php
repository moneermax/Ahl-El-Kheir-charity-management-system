...
<div class="row g-3 mb-4 fade-in">
    <!-- Box 1: Total Transactions (Blue) -->
    <div class="col-md-3 col-sm-6">
        <div class="card stat-card border border-primary h-100">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="text-muted mb-1"><?php echo e(t('accounting.total_transactions')); ?></h6>
                        <h3 class="mb-0"><?php echo (int)($accountingStats['tx_count'] ?? 0); ?></h3>
    ...
    <!-- Box 2: Month Collection (Green) -->
    <div class="col-md-3 col-sm-6">
        <div class="card stat-card border border-success h-100">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="text-muted mb-1"><?php echo e(t('accounting.month_collection')); ?></h6>
                        <h3 class="mb-0"><?php echo number_format((float)($accountingStats['month_total'] ?? 0), 0); ?></h3>
                        <small class="text-muted"><?php echo e(t('accounting.currency_sdg')); ?></small>
                    </div>
    ...
    <!-- Box 3: Pending Income (Yellow) -->
    <div class="col-md-3 col-sm-6">
        <div class="card stat-card border border-warning h-100">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="text-muted mb-1"><?php echo e(t('accounting.pending_income')); ?></h6>
                        <h3 class="mb-0"><?php echo (int)($accountingStats['pending_inflows'] ?? 0); ?></h3>
                        <small class="text-muted">معاملة</small>
                    </div>
    ...
    <!-- Box 4: Pending Outflows (Red) -->
    <div class="col-md-3 col-sm-6">
        <div class="card stat-card border border-danger h-100">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="text-muted mb-1"><?php echo e(t('accounting.pending_outflows')); ?></h6>
                        <h3 class="mb-0"><?php echo (int)($accountingStats['pending_outflows'] ?? 0); ?></h3>
                        <small class="text-muted"><?php echo number_format((float)($accountingStats['outflow_amount_pending'] ?? 0), 0); ?> <?php echo e(t('accounting.currency_sdg')); ?></small>
                    </div>
    ...
    <div class="col-md-3 col-sm-6">
        <div class="card fade-in border-warning h-100">
            <div class="card-body text-center d-flex flex-column justify-content-center">
                ...
                <h3 class="mb-0"><?php echo (int)($group_stats['submitted_count'] ?? 0); ?></h3>
                <small class="text-muted"><?php echo e(t('dashboard.groups_pending_review')); ?></small>
            </div>
        </div>
    </div>
    <div class="col-md-3 col-sm-6">
        <div class="card fade-in border-info h-100">
            <div class="card-body text-center d-flex flex-column justify-content-center">
                ...
                <h3 class="mb-0"><?php echo (int)($group_stats['approved_count'] ?? 0); ?></h3>
                <small class="text-muted"><?php echo e(t('dashboard.batches_pending_receipt')); ?></small>
            </div>
        </div>
    </div>
    <div class="col-md-3 col-sm-6">
        <div class="card fade-in border-success h-100">
            <div class="card-body text-center d-flex flex-column justify-content-center">
                ...
                <h3 class="mb-0"><?php echo (int)($group_stats['transferred_count'] ?? 0); ?></h3>
                <small class="text-muted"><?php echo e(t('dashboard.groups_transferred')); ?></small>
            </div>
        </div>
    </div>
    <div class="col-md-3 col-sm-6">
        <div class="card fade-in border-primary h-100">
            <div class="card-body text-center d-flex flex-column justify-content-center">
                ...
                <small class="text-muted"><?php echo e(t('dashboard.assigned_nannies')); ?></small>
            </div>
        </div>
    </div>
</div>
                    ...
                    <table class="table align-middle mb-0">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo e(t('accounting.sponsor')); ?></th>
