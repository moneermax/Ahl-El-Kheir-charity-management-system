...
.page{min-height:100vh;display:flex;align-items:center;justify-content:center;padding:42px 34px 32px;position:relative;z-index:1;zoom:.9}
...
@media(max-width:900px){.page{padding:75px 22px 65px;zoom:1}.wrapper{grid-template-columns:1fr;max-width:620px;gap:38px}.visual{order:1}.card-wrap{order:2}.footer{position:relative;bottom:auto;margin-top:25px}.language{top:18px;inset-inline-end:18px}.goals{max-width:600px}.login-card{max-width:520px}}
