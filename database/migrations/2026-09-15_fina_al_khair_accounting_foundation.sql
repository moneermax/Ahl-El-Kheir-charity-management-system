...
-- Phase 1: schema only. No historical financial data is rewritten.
...
SELECT '2300', 'أموال مستحقة لفينا الخير', 'Funds Payable to Fina Al-Khair', 'liability', NULL, 1,
...
CREATE TABLE IF NOT EXISTS payment_allocations (
    ...
    UNIQUE KEY uq_payment_allocations_code (allocation_code),
    KEY idx_payment_allocations_sp (sponsor_payment_id),
    KEY idx_payment_allocations_txn (transaction_id),
    KEY idx_payment_allocations_sponsorship (sponsorship_id),
    KEY idx_payment_allocations_destination (destination_type),
...
CREATE TABLE IF NOT EXISTS fina_settlements (
    ...
    destination_account_reference VARCHAR(150) NULL,
    external_reference VARCHAR(100) NULL,
...
CREATE TABLE IF NOT EXISTS fina_settlement_allocations (
    ...
    KEY idx_fsa_settlement (settlement_id),
    KEY idx_fsa_allocation (allocation_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
